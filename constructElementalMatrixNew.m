function [E, elements] = constructElementalMatrixNew(metFormulas, metCharges)
...
load(which('atomicNumbersbest.mat')) % Load list of elements (s) and their atomic numbers (n)
...
for i = 1:m
    ...
    for j = 1:p-1
        E(i,j) = numAtomsOfElementInFormula(f,s{j}); %Gives the number of atoms for an element in the metabolite.
    end
